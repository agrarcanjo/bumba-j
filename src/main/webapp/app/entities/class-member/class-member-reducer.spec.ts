...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSMEMBER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSMEMBER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSMEMBER actions', async () => {
      const arg = { id: 29969 };
    ...
    it('dispatches UPDATE_CLASSMEMBER actions', async () => {
      const arg = { id: 29969 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSMEMBER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSMEMBER actions', async () => {
      const arg = 42666;
