...
import com.bumbatech.bumbalearning.service.UserProfileQueryService;
...
/**
 * REST controller for managing {@link com.bumbatech.bumbalearning.domain.UserProfile}.
 */
@RestController
...
public class UserProfileResource {
    ...
    public ResponseEntity<List<UserProfileDTO>> getAllUserProfiles(UserProfileCriteria criteria) {
        ...
        List<UserProfileDTO> entityList = userProfileQueryService.findByCriteria(criteria);
