...
import { deleteEntity, getEntity } from './achievement.reducer';

export const AchievementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bumbaApp.achievement.delete.question">
        <Translate contentKey="bumbaApp.achievement.delete.question" interpolate={{ id: achievementEntity.id }}>
