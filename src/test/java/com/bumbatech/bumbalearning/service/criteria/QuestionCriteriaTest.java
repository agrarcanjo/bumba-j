...
class QuestionCriteriaTest {
    ...
    private static void setAllFilters(QuestionCriteria questionCriteria) {
        ...
        questionCriteria.language();
        questionCriteria.skill();
        questionCriteria.level();
        questionCriteria.createdAt();
        questionCriteria.prompt();
        questionCriteria.topicId();
        questionCriteria.createdById();
    ...
    private static Condition<QuestionCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getSkill()) &&
                condition.apply(criteria.getLevel()) &&
                condition.apply(criteria.getCreatedAt()) &&
                condition.apply(criteria.getPrompt()) &&
    ...
    private static Condition<QuestionCriteria> copyFiltersAre(QuestionCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getSkill(), copy.getSkill()) &&
                condition.apply(criteria.getLevel(), copy.getLevel()) &&
                condition.apply(criteria.getCreatedAt(), copy.getCreatedAt()) &&
                condition.apply(criteria.getPrompt(), copy.getPrompt()) &&
