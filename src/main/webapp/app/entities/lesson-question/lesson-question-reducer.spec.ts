...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LESSONQUESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LESSONQUESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LESSONQUESTION actions', async () => {
      const arg = { id: 6340 };
    ...
    it('dispatches UPDATE_LESSONQUESTION actions', async () => {
      const arg = { id: 6340 };
    ...
    it('dispatches PARTIAL_UPDATE_LESSONQUESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LESSONQUESTION actions', async () => {
      const arg = 42666;
