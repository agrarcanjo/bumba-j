...
import { deleteEntity, getEntity } from './class-room.reducer';
...
export const ClassRoomDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/class-room${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bumbaApp.classRoom.delete.question">
        <Translate contentKey="bumbaApp.classRoom.delete.question" interpolate={{ id: classRoomEntity.id }}>
