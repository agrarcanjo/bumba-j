  ...
  return (
    <div>
      <h2 id="topic-heading" data-cy="TopicHeading">
        <Translate contentKey="bumbaApp.topic.home.title">Topics</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="bumbaApp.topic.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/topic/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="bumbaApp.topic.home.createLabel">Create new Topic</Translate>
          </Link>
        </div>
      </h2>
        ...
        {topicList && topicList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="bumbaApp.topic.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="bumbaApp.topic.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
            ...
            <tbody>
              {topicList.map((topic, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{topic.name}</td>
                  <td>
                    <Translate contentKey={`bumbaApp.Language.${topic.language}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bumbaApp.topic.home.notFound">No Topics found</Translate>
            </div>
          )
        )}
      </div>
