...
import reducer, {
  ...
  reset,
  updateEntity,
} from './student-lesson-progress.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTLESSONPROGRESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTLESSONPROGRESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTLESSONPROGRESS actions', async () => {
      const arg = { id: 4224 };
    ...
    it('dispatches UPDATE_STUDENTLESSONPROGRESS actions', async () => {
      const arg = { id: 4224 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTLESSONPROGRESS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTLESSONPROGRESS actions', async () => {
      const arg = 42666;
