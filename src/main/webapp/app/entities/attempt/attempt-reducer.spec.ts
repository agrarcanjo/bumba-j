...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './attempt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTEMPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ATTEMPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ATTEMPT actions', async () => {
      const arg = { id: 536 };
    ...
    it('dispatches UPDATE_ATTEMPT actions', async () => {
      const arg = { id: 536 };
    ...
    it('dispatches PARTIAL_UPDATE_ATTEMPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ATTEMPT actions', async () => {
      const arg = 42666;
