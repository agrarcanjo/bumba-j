...
public class LessonTestSamples {
    ...
    public static Lesson getLessonSample1() {
        return new Lesson().id(1L).title("title1").xpReward(1).passThreshold(1).description("description1");
    }

    public static Lesson getLessonSample2() {
        return new Lesson().id(2L).title("title2").xpReward(2).passThreshold(2).description("description2");
    }
    ...
    public static Lesson getLessonRandomSampleGenerator() {
        return new Lesson()
            ...
            .passThreshold(intCount.incrementAndGet())
