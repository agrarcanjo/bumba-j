...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERACHIEVEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERACHIEVEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERACHIEVEMENT actions', async () => {
      const arg = { id: 20469 };
    ...
    it('dispatches UPDATE_USERACHIEVEMENT actions', async () => {
      const arg = { id: 20469 };
    ...
    it('dispatches PARTIAL_UPDATE_USERACHIEVEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERACHIEVEMENT actions', async () => {
      const arg = 42666;
