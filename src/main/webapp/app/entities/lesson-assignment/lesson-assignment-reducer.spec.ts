...
import reducer, {
  ...
  reset,
  updateEntity,
} from './lesson-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LESSONASSIGNMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LESSONASSIGNMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LESSONASSIGNMENT actions', async () => {
      const arg = { id: 19025 };
    ...
    it('dispatches UPDATE_LESSONASSIGNMENT actions', async () => {
      const arg = { id: 19025 };
    ...
    it('dispatches PARTIAL_UPDATE_LESSONASSIGNMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LESSONASSIGNMENT actions', async () => {
      const arg = 42666;
