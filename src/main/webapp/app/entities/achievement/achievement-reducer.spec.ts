...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACHIEVEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACHIEVEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACHIEVEMENT actions', async () => {
      const arg = { id: 27064 };
    ...
    it('dispatches UPDATE_ACHIEVEMENT actions', async () => {
      const arg = { id: 27064 };
    ...
    it('dispatches PARTIAL_UPDATE_ACHIEVEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACHIEVEMENT actions', async () => {
      const arg = 42666;
